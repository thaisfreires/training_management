...
const NotFound = () => {
    return (
        <div className=''>
            <div className="px-5 py-10 sm:py-20">
                <div className="mx-auto max-w-[410px]">
                    ...
                    <div className="mt-7.5 text-center">
                        ...
                        <Link className="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-white hover:bg-opacity-90" to="/dashboard">
