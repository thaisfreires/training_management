...
const AlertItem: React.FC<AlertItemProps> = ({ type, message }) => {
  ...
  const { border, bg, textColor, icon, title } = alertStyles[type];

  return (
    <div className={`flex w-full border-l-6 ${border} ${bg} px-7 py-8 shadow-md`}>
      <div className="mr-5 flex h-9 w-9 items-center justify-center rounded-lg">{icon}</div>
