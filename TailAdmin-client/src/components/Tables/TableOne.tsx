  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex flex-col">
        ...
        {courses.map((course) => (
          <div className="grid grid-cols-4 sm:grid-cols-5" key={course.id}>

            <div className="flex items-center gap-3 p-2.5 xl:p-5">
              <p className="hidden text-black dark:text-white sm:block">{course.name}</p>
            </div>

            <div className="flex items-center justify-center p-2.5 xl:p-5" key={course.entity_id}>
              <p className="text-black dark:text-white">{course.entity_id.name}</p>
            </div>

            <div className="flex items-center justify-center p-2.5 xl:p-5">
              <p className="text-black dark:text-white">{course.duration}</p>
            </div>

            <div className="flex items-center justify-center p-2.5 xl:p-5">
              <p className="text-black dark:text-white">{course.location_id}</p>
            </div>
